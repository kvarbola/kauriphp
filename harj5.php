...
<body>
    ...
    $kokku = count($autod);
    $vin_kokku = count($vin_koodid);
    $Taudotad = array_count_values($autod);
    
    echo "Autosid on kokku: $kokku.<br>";
    if ($kokku == $vin_kokku) {
        echo "Massiivid on võrdsed<br>";
    } else {
        echo "Massiivid ei ole võrdsed<br>";
    }
    
    echo "Toyotasid on kokku: ";
    echo $Taudotad['Toyota'];
    echo "<br>";
    echo "Audisid on kokku: ";
    echo $Taudotad['Audi'];
    echo "<br>";
    echo "Koodid, mis on lühemad kui 17 märki: <br>";
    ...
    echo "2018 palkade keskmine on: ";
    echo $kesk / count($palgad);
    echo "<br>";
